                                ...
                                <div class="tab-content" id="custom-tabs-three-tabContent">
                                    ...
                                    <div class="tab-pane fade <?php if($i == "0") { echo "show active";  } ?>" id="<?php echo $data[$i] ?>" role="tabpanel" aria-labelledby="<?php echo $data[$i] ?>-home">
                                        <div class="col-md-12">
                                            ...
                                            /.card-header -->
                                                <!-- form start -->
                                                <form id="categoryAddForm-<?php echo $data[$i]; ?>" method="post">
                                                    <div class="card-body">
                                                    ...
                                                    <div class="card-footer">
                                                        <button onclick="Category.categoryAdd('<?php echo site_url() ?>category/add_form','<?php echo $data[$i]; ?>','<?php echo base_url('category') ?>')" style="float: right;"  type="button" class="btn btn-primary">Submit</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
