                                    ...
                                    <?php for ($i = 0; $i < count($data); $i++) { ?>
                                        ...
                                        <div class="col-md-12">
                                                ...
                                                /.card-header -->
                                                    ...
                                                    <form id="categoryAddForm-<?php echo $result[$i]->lang; ?>" method="post">
                                                        <div class="card-body">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Title</label>


                                                                <input type="text" name="title[<?php echo $result[$i]->lang; ?>]" value="<?php if ($result[$i]->lang == $data[$i]) { echo $result[$i]->title; } ?>"  class="form-control" id="exampleInputEmail1" >
                                                            </div>
                                                            <div class="form-group">
                                                        ...
                                                        <div class="card-footer">
                                                            <button onclick="Category.categoryEdit('<?php echo site_url() ?>category/edit_form','<?php echo $result[$i]->lang; ?>','<?php echo base_url('category') ?>')" style="float: right;"  type="button" class="btn btn-primary">Submit</button>
                                                        </div>
                                                    </form>
