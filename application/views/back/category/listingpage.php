                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="<?php echo site_url() ?>category/add"><button class="btn btn-primary btn-xs" style="float: right">Category Add</button></a>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo base_url('category/image') ?>/<?= $item->id; ?>"><button class="mt-1 btn btn-warning btn-block btn-xs"><i class="fas fa-image"></i> İmage Page</button></a>
