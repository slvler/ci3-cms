                                    ...
                                    <?php for ($i = 0; $i < count($data); $i++) { ?>
                                        <div class="tab-pane fade <?php if($i == "0") { echo "show active";  } ?>" id="<?php echo $data[$i] ?>" role="tabpanel" aria-labelledby="<?php echo $data[$i] ?>-home">
                                            <div class="col-md-12">
                                                ...
                                                /.card-header -->
                                                    <!-- form start -->
                                                    <form id="subcategoryAddForm-<?php echo $data[$i]; ?>" method="post">
                                                        <div class="card-body">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Title</label>
                                                                <input type="text" name="title[<?php echo $data[$i]; ?>]" class="form-control" id="exampleInputEmail1" placeholder="title">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Desc</label>
                                                                <input type="text" name="desc[<?php echo $data[$i]; ?>]" class="form-control" id="exampleInputEmail1" placeholder="Desc">
                                                            </div>
                                                            <div class="form-group">
                                                        ...
                                                        <div class="card-footer">
                                                            <button onclick="Subcategory.subcategoryAdd('<?php echo site_url() ?>subcategory/add_form','<?php echo $data[$i]; ?>','<?php echo base_url('subcategory') ?>')" style="float: right;"  type="button" class="btn btn-primary">Submit</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
