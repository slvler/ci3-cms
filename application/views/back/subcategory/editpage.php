                                        ...
                                        <div class="tab-pane fade <?php if($i == "0") { echo "show active";  } ?>" id="<?php echo $data[$i] ?>" role="tabpanel" aria-labelledby="<?php echo $data[$i] ?>-home">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                /.card-header -->
                                                    ...
                                                    <form id="subcategoryEditForm-<?php echo $data[$i]; ?>" method="post">
                                                        <div class="card-body">
                                                            ...
                                                            $dataV = [];
                                                           $stepV = json_decode($result[$i]->category_id);
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="category[]"  class="select2" multiple="multiple" data-placeholder="Select a State" style="width: 100%;">
                                                                    ...
                                                                    <?php  foreach ($category as $cate){ ?>
                                                                                <option <?php $stepTwo = explode(",",$stepV->id);  foreach ($stepTwo as $v){ ?> <?php  if ($v == $cate->id){ echo "selected='selected'"; } ?> <?php } ?> value="<?php echo $cate->id; ?>" ><?php echo $cate->title ?></option>
                                                                    <?php  }  ?>
                                                        ...
                                                        <div class="card-footer">
                                                            <button onclick="Subcategory.subcategoryEdit('<?php echo site_url() ?>subcategory/edit_form','<?php echo $result[$i]->lang; ?>','<?php echo base_url('subcategory') ?>')" style="float: right;"  type="button" class="btn btn-primary">Submit</button>
